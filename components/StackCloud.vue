...
=
      <div class="text-center mb-12">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Tools to Facilitate the Process</h2>
      </div>


      <div class="grid-cols-1 flex gap-8 overflow-x-auto justify-items-center items-center max-w-6xl mx-auto">
        <div v-for="tool in tools" :key="tool.id" class="flex flex-col items-center gap-2">
          <img :src="tool.icon" :alt="tool.name" class="w-10 h-10 object-contain hover:scale-110 transition-transform duration-200" />
...
<!-- <template>
  <section class="w-full bg-white py-16">
    <div class="container mx-auto px-4">
      ...
      <div
        class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center justify-items-center max-w-6xl mx-auto"
      >
        <div
          v-for="tool in tools"
          :key="tool.id"
        ...
        >
          <img
            :src="tool.icon"
            :alt="tool.name"
            class="w-12 h-12 object-contain hover:scale-110 transition-transform duration-200"
          />
...
<!-- <template>
  <section class="w-full bg-white py-16">
    <div class="container mx-auto px-4">
      ...
      <div
        class="flex gap-8 overflow-x-auto items-center max-w-6xl mx-auto px-4"
