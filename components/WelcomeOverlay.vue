      ...
      <div v-if="showWelcome" class="fixed inset-0 z-50 flex items-center justify-center bg-white">
        <div class="text-center max-w-md px-6">
          <div class="relative w-64 h-64 mx-auto mb-6">
            <img src="/illustrations/welcome-food.svg" alt="Welcome to eleste" class="w-full h-full object-contain animate-float" />
          ...
          <h1 class="text-3xl font-bold mb-3 text-gray-800">Welcome to <span class="text-red-500">eleste</span></h1>
